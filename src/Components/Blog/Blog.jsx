...
const Blog = ({blog, handleAddToBookmarks}) => { // singular object from blogs.json after .map and received handleAddToBookmarks from <Blogs>

    const {blog_title, date_posted, cover_image, reading_time, hashtags, author_name, author_img} = blog; // destructuring.

    return (
        <div className='mb-14'>
            <img className='w-full max-w-[52.80rem] h-auto object-cover' src={cover_image} alt={`cover picture`} />
